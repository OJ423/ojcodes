...
export default function MobileNavigation() {
  ...
  return(
    <nav className="sm:hidden items-align-center">
      <ul>
        <Link href="/skills"><li className={`list-none inline-block me-2 ${activePage.includes('/skills') ? `text-teal-500` : null}`}><IoIosFlame aria-label="Skills page" size={25}/></li></Link>
